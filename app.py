...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Huệ - Trường Tiểu học Minh Quang - ĐT: 098 3750 076</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Huệ - Trường Tiểu học Minh Quang - ĐT: 098 3750 076</div>", unsafe_allow_html=True)
